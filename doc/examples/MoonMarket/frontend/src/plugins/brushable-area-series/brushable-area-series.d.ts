...
export interface BrushableAreaSeriesOptions extends CustomSeriesOptions, BrushableAreaStyle {
	basePrice: number;
	/**
...
declare class BrushableAreaSeriesRenderer<TData extends BrushableAreaData> implements ICustomSeriesPaneRenderer {
	_data: PaneRendererCustomData<Time, TData> | null;
	_options: BrushableAreaSeriesOptions | null;
...
export declare class BrushableAreaSeries<TData extends BrushableAreaData> implements ICustomSeriesPaneView<Time, TData, BrushableAreaSeriesOptions> {
	...
	update(data: PaneRendererCustomData<Time, TData>, options: BrushableAreaSeriesOptions): void;
	defaultOptions(): BrushableAreaSeriesOptions;
}
